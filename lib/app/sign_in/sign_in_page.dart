...
import 'package:oas_mobile/app/sign_in/email_sign_in_page.dart';
import 'package:oas_mobile/app/sign_in/sign_in_manager_old.dart';
import 'package:oas_mobile/app/sign_in/sign_in_button.dart';
import 'package:oas_mobile/app/sign_in/social_sign_in_button.dart';
...
class SignInPage extends StatelessWidget {
  final SignInManagerOld manager;
  ...
  static Widget create(BuildContext context) {
    ...
    return ChangeNotifierProvider<ValueNotifier<bool>>(
      ...
      child: Consumer<ValueNotifier<bool>>(
        builder: (_, isLoading, __) => Provider<SignInManagerOld>(
          create: (_) => SignInManagerOld(auth: auth, isLoading: isLoading),
          child: Consumer<SignInManagerOld>(
  ...
  Future<void> _signInWithGoogle(BuildContext context) async {
    try {
      final userCredential = await manager.signInWithGoogle();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: OasAppBar(
        titleWidget: Image.asset('assets/images/OpenArtSource_white_text_only.png'),
        withLogo: true,
      ),
